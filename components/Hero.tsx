        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute top-10 lg:top-20 left-0 lg:left-4 bg-white/80 backdrop-blur-xl p-4 lg:p-5 rounded-2xl shadow-xl border border-white/50 flex items-center gap-3 lg:gap-4 w-56 lg:w-64 scale-90 lg:scale-100 origin-top-left z-10"
            >
            ...
            <motion.div 
              ...
              className="absolute bottom-20 lg:bottom-32 right-0 lg:-right-8 bg-white/80 backdrop-blur-xl p-4 lg:p-5 rounded-2xl shadow-xl border border-white/50 w-48 lg:w-56 scale-90 lg:scale-100 origin-bottom-right z-10"
            >

...
export default function BmiCalculator() {
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="absolute top-0 right-0 w-1/3 h-full bg-brand-50 rounded-l-full opacity-50 -z-10 transform transtone-x-1/3"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <ul className="space-y-3 mb-8 text-stone-600 font-medium">
          ...
          >
            <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-stone-100 relative">
              <h3 className="text-2xl font-bold text-stone-900 mb-6">BMI Calculator</h3>
              
              <form onSubmit={calculateBMI} className="space-y-5">
                <div>
                  <label htmlFor="height" className="block text-sm font-semibold text-stone-700 mb-2">
                    Height (in cm)
                  </label>
                  <input
                    id="height"
                    ...
                    placeholder="e.g. 175"
                    className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all bg-stone-50 focus:bg-white text-stone-900 font-medium placeholder:text-stone-400"
                    required
                  />
                </div>
                <div>
                  <label htmlFor="weight" className="block text-sm font-semibold text-stone-700 mb-2">
                    Weight (in kg)
                  </label>
                  <input
                    id="weight"
              ...
              {bmi && (
                ...
                >
                  ...
                  <div className="text-5xl font-bold text-stone-900 mb-2 font-serif">{bmi}</div>
